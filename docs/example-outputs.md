...
So as the serializers within here are interchangable here is an extract from the tests which shows the same object being spat out through 3 different serializers:
